...
<body>
	...
	<form id="login" action="<?=$base_url?>user" method="post">
			<h3>Connexion</h3>
			<p><?echo "$alert"?><p>
			<p><input type="text" id="login" name="login" pattern=".[a-zA-Z0-9@._-]{1,}" value="<?=$login?>" placeholder="Login ou adresse mail" autofocus/></p>
		...
		<div style="text-align:center">
			...
			<small><a href="<?=$base_url?>user/reset" style="color: #333c4a">Mot de passe oublié ?</a></small>
		</div>
	</div>
